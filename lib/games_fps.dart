...
class GamesFpsPage extends StatefulWidget {
  final String fileName;
  const GamesFpsPage({Key? key, required this.fileName}) : super(key: key);

  @override
  MyAppState createState() => MyAppState();
}

class MyAppState extends State<GamesFpsPage> {
  ...
  var testRaycaster = three.Raycaster();
  ...
  void animate() {
    ...
    List intersects = testRaycaster.intersectObjects(scene.children, false);
