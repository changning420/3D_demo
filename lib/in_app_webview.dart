        ...
        child: Stack(
          children: [
            InAppWebView(
              ...
              initialFile: 'assets/html/js_flutter_test.html',

              // initialUrlRequest: URLRequest(
              //     url: Uri.parse(
              //         "https://api.ly-lens.com/lylens/h5/?page=login&env=mobile")),
              ...
              onWebViewCreated: (controller) async {
                ...
                webViewController?.addJavaScriptHandler(
                    handlerName: 'xxoo',
                    callback: (data) {
                      print('addJavaScriptHandler在这里处理H5传递过来的数据String: $data');
                    });
                ...
                controller.addWebMessageListener(WebMessageListener(
                  ...
                  onPostMessage:
                    ...
                    print(
                        'addWebMessageListener在这里处理H5传递过来的数据String: $message');
                  },
                ));
              },
